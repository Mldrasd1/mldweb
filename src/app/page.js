      ...
      <section className="flex flex-col md:flex-row items-center justify-between mt-16 w-full max-w-6xl  mx-auto px-10">
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="text-gray-500 mb-6 leading-relaxed max-w-md mx-auto md:mx-0">
            Book, view, and organize your appointments all in one place. Our
            system is designed to save you time and keep you organized, whether
            youre booking for yourself or managing multiple schedules.
          </p>
